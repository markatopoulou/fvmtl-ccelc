#ifndef CAFFE_HINGE_LOSS_BINARY_LAYER_HPP_
#define CAFFE_HINGE_LOSS_BINARY_LAYER_HPP_
...
/**
 * @brief Computes the hinge loss for a binary [1/-1] classification task.
 *
...
class HingeLossBinaryLayer : public LossLayer<Dtype> {
 public:
  explicit HingeLossBinaryLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param) {}

  virtual inline const char* type() const { return "HingeLoss"; }

 protected:
  /// @copydoc HingeLossBinaryLayer
