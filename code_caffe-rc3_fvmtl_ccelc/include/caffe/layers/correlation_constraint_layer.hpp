#ifndef CAFFE_CORRELATION_CONSTRAINT_LAYER_HPP_
#define CAFFE_CORRELATION_CONSTRAINT_LAYER_HPP_
...
class CorrelationConstraintLayer : public LossLayer<Dtype> {
 public:
  explicit CorrelationConstraintLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "CorrelationConstraint"; }
